...
var LogisticsSharedCommonModule = (function () {
    function LogisticsSharedCommonModule() {
    }
    return LogisticsSharedCommonModule;
}());
LogisticsSharedCommonModule = __decorate([
    core_1.NgModule({
        imports: [
            _1.LogisticsSharedLibsModule
        ],
        declarations: [
...
exports.LogisticsSharedCommonModule = LogisticsSharedCommonModule;
