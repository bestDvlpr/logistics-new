...
var LogisticsSharedLibsModule = (function () {
    function LogisticsSharedLibsModule() {
    }
    return LogisticsSharedLibsModule;
}());
LogisticsSharedLibsModule = __decorate([
    core_1.NgModule({
        imports: [
...
exports.LogisticsSharedLibsModule = LogisticsSharedLibsModule;
