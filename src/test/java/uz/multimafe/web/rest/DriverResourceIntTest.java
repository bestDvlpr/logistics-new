...
import uz.multimafe.service.mapper.DriverMapper;
...
public class DriverResourceIntTest {
    ...
    private static final String DEFAULT_PHONE = "+676043188055";
    private static final String UPDATED_PHONE = "+893708463188";
    ...
    public void createDriverWithExistingId() throws Exception {
        ...
        DriverDTO existingDriverDTO = driverMapper.driverToDriverDTO(existingDriver);

        // An entity with an existing ID cannot be created, so this API call must fail
        restDriverMockMvc.perform(post("/api/drivers")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingDriverDTO)))
